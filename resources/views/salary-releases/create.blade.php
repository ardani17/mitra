<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('finance.salary-releases.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('finance.salary-releases.store') }}" class="space-y-6">
                        @csrf
                        ...
                        <div class="flex flex-wrap gap-2">
                            <button type="button" class="period-btn bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded text-sm" 
                        ...
                        <div id="salary-preview" class="hidden">
                            <h3 class="text-lg font-medium text-gray-900 mb-4">Gaji yang Akan Dirilis</h3>
                            <div class="bg-gray-50 border border-gray-200 rounded-md p-4">
                                ...
                                <div class="mt-4 pt-4 border-t border-gray-300">
                                    <div class="flex justify-between items-center">
                                        <span class="font-medium text-gray-900">Total Kotor:</span>
                                        <span class="font-bold text-green-600" id="total-gross">Rp 0</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            @error('deductions')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-sm text-gray-500">Potongan seperti BPJS, pajak, dll (opsional)</p>
                        </div>

                        <!-- Net Amount Display -->
                        <div class="bg-green-50 border border-green-200 rounded-md p-4">
                            <div class="flex justify-between items-center">
                                <span class="text-lg font-medium text-green-800">Total Bersih:</span>
                                <span class="text-2xl font-bold text-green-600" id="net-amount-display">Rp 0</span>
                            </div>
                        </div>
                        ...
                        <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                            ...
                            <button type="submit" id="submit-btn" disabled
                                ...
                                <i class="fas fa-save mr-2"></i>Buat Rilis Gaji
                            </button>
                        </div>
                    </form>
                </div>
