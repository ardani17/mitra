...
<div class="container mx-auto px-8 lg:px-16 xl:px-24 py-8 max-w-6xl">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Buat Batch Penagihan Baru</h1>
        ...
        <form action="{{ route('billing-batches.store') }}" method="POST" id="batchForm">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">No SP *</label>
            ...
            <div class="mb-8">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-semibold text-gray-800">Pilih Proyek untuk Penagihan</h3>
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="mt-2 grid grid-cols-2 md:grid-cols-4 gap-4 text-xs text-gray-600">
                                            <div>
                                                ...
                                                Rp {{ number_format($project->final_service_value, 0, ',', '.') }}
                                            </div>
                                            <div>
                                                <span class="font-medium">Nilai Material:</span><br>
                                                Rp {{ number_format($project->final_material_value, 0, ',', '.') }}
                                            </div>
                                            <div>
                                                <span class="font-medium">Total DPP:</span><br>
                                                Rp {{ number_format($project->final_service_value + $project->final_material_value, 0, ',', '.') }}
                                            </div>
                                            <div>
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Semua proyek sudah ditagih atau belum memiliki nilai final.</p>
                        <div class="mt-6">
                            <a href="{{ route('projects.index') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
                                Lihat Proyek
                            </a>
                        </div>
                    </div>
            ...
            <div class="mb-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <div class="mb-4 p-3 bg-white rounded border">
                    <h5 class="text-sm font-medium text-gray-700 mb-2">Pilih Tipe Klien untuk Batch:</h5>
            ...
            <div class="flex justify-end space-x-4">
                <a href="{{ route('billing-batches.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded">
                    Batal
                </a>
                <button type="submit" id="submitBtn" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded disabled:opacity-50" disabled>
    ...
    <div class="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        <div class="flex">
            ...
            <div class="ml-3">
                <h3 class="text-sm font-medium text-yellow-800">Informasi Batch Penagihan</h3>
