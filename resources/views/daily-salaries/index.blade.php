        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="GET" action="{{ route('finance.daily-salaries.index') }}" class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                            ...
                            <div>
                                <label for="released" class="block text-sm font-medium text-gray-700">Rilis</label>
                                <select name="released" id="released" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            ...
                            <div class="flex items-end space-x-2">
                                ...
                                <a href="{{ route('finance.daily-salaries.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded">
                                    Reset
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="mb-4 flex justify-between items-center">
                            ...
                            <div class="flex space-x-2">
                                <button type="button" id="bulk-confirm-btn" 
                                        ...
                                        disabled>
                                    <i class="fas fa-check mr-2"></i>Konfirmasi Terpilih
                                </button>
                            </div>
                        </div>
                    ...
                    @else
                        <div class="text-center py-12">
                            <div class="text-gray-500 text-lg mb-4">
                                ...
                                <p>Belum ada data gaji harian</p>
                            </div>
                            <a href="{{ route('finance.daily-salaries.create') }}" 
                               class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                <i class="fas fa-plus mr-2"></i>Input Gaji Pertama
                            </a>
                        </div>
                    @endif
                </div>
